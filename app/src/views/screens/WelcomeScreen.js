...
const WelcomeScreen = ({ navigation }) => {
    return (
        <>
            <SafeAreaView
                style={{ paddingHorizontal: "1%", width: Dimensions.get('screen').width, height: Dimensions.get('screen').height }}>
                <View style={{ flex: 1, backgroundColor: '' }}>
                    ...
                    {/* 
                    <View style={{ flex: 1, backgroundColor: '#fff', justifyContent: 'space-around' }}>
                        <TouchableOpacity onPress={() => navigation.navigate('AxiosFetch')}>
                            <View style={{}}>
                                <View style={STYLES.btnPrimary}>
                                    <Text style={{ color: '#ffffff', fontSize: 18, fontWeight: 'bold' }}>
                                        Feetch
