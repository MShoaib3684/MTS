...
import Unsplash from './app/src/views/screens/Unsplash';
import Unsplash1 from './app/src/views/screens/Unsplash1';
import Unsplash2 from './app/src/views/screens/Unsplash2';
import AxiosFetch from './app/src/views/screens/AxiosFetch';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="WelcomeScreen" screenOptions={{ header: () => null }} >
        ...
        <Stack.Screen name="Unsplash1" component={Unsplash1} />
        <Stack.Screen name="Unsplash2" component={Unsplash2} />
        <Stack.Screen name="Unsplash" component={Unsplash} />
        <Stack.Screen name="AxiosFetch" component={AxiosFetch} />
